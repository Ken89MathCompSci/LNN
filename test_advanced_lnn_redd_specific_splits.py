...
def train_on_appliance(data_dict, appliance_name, window_size=100,
                       ...
                       save_dir='models/advanced_lnn_redd_specific'):
...
def test_on_all_appliances(window_size=100, hidden_size=64, num_layers=2, dt=0.1,
    ...
    base_save_dir = f"models/advanced_lnn_redd_specific_test_{timestamp}"
...
if __name__ == "__main__":
    print("Testing Advanced-LNN on REDD dataset with specific splits...")
    ...
    print(f"\nSummary of Advanced-LNN testing on REDD dataset:")
