...
def train_on_appliance(splits, appliance_name, save_dir,
    ...
    plt.savefig(os.path.join(save_dir,
        f"tcn_advanced_lnn_two_asymmetric_loss_redd_{appliance_name.replace(' ', '_')}_metrics.png"),
    ...
    with open(os.path.join(save_dir,
            f'tcn_advanced_lnn_two_asymmetric_loss_redd_{appliance_name.replace(" ", "_")}_history.json'),
...
def run_all(hidden_size=64, num_layers=2, dt=0.1,
    ...
    base_save_dir = f"models/tcn_advanced_lnn_two_asymmetric_loss_redd_test_{timestamp}"
    ...
    # Console table
    print(f"\nTCN-Advanced-LNN-Two (Asymmetric Loss) REDD testing completed.")
