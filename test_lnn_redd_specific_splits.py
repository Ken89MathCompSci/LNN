...
def train_on_appliance(data_dict, appliance_name, window_size=100,
                       ...
                       save_dir='models/lnn_redd_specific'):
...
def test_on_all_appliances(window_size=100, hidden_size=64, dt=0.1,
    ...
    base_save_dir = f"models/lnn_redd_specific_test_{timestamp}"
    ...
    print(f"\nLiquidNetworkModel REDD testing completed. Results saved to {base_save_dir}\n")
...
if __name__ == "__main__":
    print("Testing LiquidNetworkModel on REDD dataset with specific splits...")
    ...
    print(f"\nSummary of LiquidNetworkModel testing on REDD dataset:")
