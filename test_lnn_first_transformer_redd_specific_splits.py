"""
LNN-First Hybrid Transformer — REDD specific splits
====================================================
...
Usage (Colab / terminal):
    ...
    !python test_lnn_first_transformer_redd_specific_splits.py --appliance fridge
    !python test_lnn_first_transformer_redd_specific_splits.py --appliance microwave
    !python test_lnn_first_transformer_redd_specific_splits.py --appliance "dish washer"
    !python test_lnn_first_transformer_redd_specific_splits.py --appliance "washer dryer"

    # regenerate plots after all four are done:
    !python test_lnn_first_transformer_redd_specific_splits.py --plot

    # optional overrides:
    !python test_lnn_first_transformer_redd_specific_splits.py --hidden 128 --epochs 60
"""
...
SAVE_DIR = os.path.join('results', 'lnn_first_transformer_redd')
COLOR    = '#D62728'
...
def plot_training_curves(results, save_dir):
    ...
    fig.suptitle('Training Curves — LNN-First Transformer (REDD)', fontsize=12)
    plt.tight_layout()
...
def plot_epoch_metrics(results, save_dir):
    ...
    fig.suptitle('Val Metrics per Epoch — LNN-First Transformer (REDD)', fontsize=12)
    plt.tight_layout()
...
def plot_bar_chart(results, save_dir):
    ...
    fig.suptitle('Final Test Metrics — LNN-First Transformer (REDD)', fontsize=12)
    plt.tight_layout()
...
def print_table(results):
    ...
    for metric, label in [('f1', 'F1'), ('precision', 'Precision'),
        ...
        print(f"\n{'='*70}")
        print(f"  {label} — LNN-First Transformer (REDD)")
        print(f"{'='*70}")
...
def main():
    parser = argparse.ArgumentParser(
        description='LNN-First Hybrid Transformer — REDD')
