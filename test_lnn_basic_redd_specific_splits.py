"""
Basic LNN (LiquidNetworkModel) — REDD specific splits
======================================================
...
Usage:
    !python test_lnn_basic_redd_specific_splits.py --appliance fridge
    !python test_lnn_basic_redd_specific_splits.py --appliance microwave
    !python test_lnn_basic_redd_specific_splits.py --appliance "dish washer"
    !python test_lnn_basic_redd_specific_splits.py --appliance "washer dryer"
    !python test_lnn_basic_redd_specific_splits.py --plot
"""
...
SAVE_DIR = os.path.join('results', 'lnn_basic_redd')
COLOR    = '#D62728'
...
def plot_training_curves(results, save_dir):
    ...
    fig.suptitle('Training Curves — Basic LNN (REDD)', fontsize=12)
    plt.tight_layout()
...
def plot_epoch_metrics(results, save_dir):
    ...
    fig.suptitle('Val Metrics per Epoch — Basic LNN (REDD)', fontsize=12)
    plt.tight_layout()
...
def plot_bar_chart(results, save_dir):
    ...
    fig.suptitle('Final Test Metrics — Basic LNN (REDD)', fontsize=12)
    plt.tight_layout()
...
def main():
    parser = argparse.ArgumentParser(description='Basic LNN — REDD')
    ...
    if all_done:
        ...
        print('Run those, then: python test_lnn_basic_redd_specific_splits.py --plot')
