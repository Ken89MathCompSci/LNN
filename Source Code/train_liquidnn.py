...
if __name__ == "__main__":
    # Train standard Liquid Neural Network models on all appliances in house 5 (change house_number for different houses)
    results, save_dir = train_liquid_all_appliances(house_number=5, advanced=False)

    # Train Advanced Liquid Neural Network models on all appliances in house 5
    results, save_dir = train_liquid_all_appliances(house_number=5, advanced=True)
